export const projects = [
  ...
  {
    title: 'Javascript FiveM API',
    description: "A javascript API which interacts with a FiveM server. It helps you receive data from the official FiveM Client API and use them in your code.",
      image: '/images/2.png',
      tags: ['NPM', 'Node', 'FiveM'],
    source: 'https://github.com/blankydev/js-fivem-api',
    visit: 'https://www.npmjs.com/package/js-fivem-api',
    id: 1,
  },
